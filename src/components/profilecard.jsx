...
export function ProfileCard(){
    return <div className="-translate-y-10 ml-10 mr-10 flex flex-col items-center justify-around rounded-xl border border-gray-200 bg-white h-[380px] w-[300px] pt-10 pb-10">
